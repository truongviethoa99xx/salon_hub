...
__decorate([
    (0, typeorm_1.ManyToOne)(() => user_entity_1.User, (user) => user.socialAccounts, { nullable: false, onDelete: 'CASCADE' }),
...
__decorate([
    ...
    __metadata("design:type", String)
], SocialAccount.prototype, "social_user_id", void 0);
__decorate([
    (0, typeorm_1.CreateDateColumn)({ type: 'timestamptz', default: () => 'CURRENT_TIMESTAMP' }),
    __metadata("design:type", Date)
], SocialAccount.prototype, "created_at", void 0);
__decorate([
    (0, typeorm_1.UpdateDateColumn)({ type: 'timestamptz', default: () => 'CURRENT_TIMESTAMP' }),
    __metadata("design:type", Date)
], SocialAccount.prototype, "updated_at", void 0);
exports.SocialAccount = SocialAccount = __decorate([
    (0, typeorm_1.Entity)('social_accounts'),
    (0, typeorm_1.Unique)(['platform', 'social_user_id'])
], SocialAccount);
